...
{
    public partial class LaptopCollection : System.Web.UI.Page
    {
        ...
        {
            getcon();
            da = new SqlDataAdapter("select ID, Product_Name, Price, Quantity, Description, Image1, Image2, Image3, Image4 from products where Product_Type='Laptop'", con);
            ds = new DataSet();
            da.Fill(ds);
