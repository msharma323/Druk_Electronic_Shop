...
namespace Electronics_shop
{
    public partial class HotDeals : System.Web.UI.Page
    {
        ...
        {
            getcon();
            da = new SqlDataAdapter("SELECT TOP 4 ID, Product_Name, Product_Type, Price, Quantity, Description, Image1, Image2, Image3, Image4 " +
                                    "FROM products ORDER BY Created_Date DESC", con);
            ds = new DataSet();
            da.Fill(ds);
