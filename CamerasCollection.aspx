<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CamerasCollection.aspx.cs" Inherits="Electronics_shop.CamerasCollection" %>
...
<div class="collection-header">
    <%-- Title changed to Camera Collection --%>
    <h2 style="color:navy;">Camera Collection</h2> 
...
<asp:Content ID="Content3" ContentPlaceHolderID="Scripts" runat="server">
    <script>
    // JavaScript functions for the image gallery are copied directly as they are generic
